...
import com.filazero.appointmentservice.dto.CreateAppointmentRequestDTO;
import com.filazero.appointmentservice.dto.UpdateAppointmentRequestDTO;
import com.filazero.appointmentservice.dto.AppointmentResponseDTO;
import com.filazero.appointmentservice.service.AppointmentService;
...
public class AppointmentController {
    ...
    @GetMapping("/{id}")
    @PreAuthorize(DOCTOR_ROLE + " or " + NURSE_ROLE + " or " + ADMIN_ROLE + " or (" + PATIENT_SELF_ACCESS + ")")
