...
-- Usando DATE_TRUNC para garantir valores determinísticos (sem milissegundos)
WITH appt AS (SELECT DATE_TRUNC('minute', NOW() + INTERVAL '5 days') + INTERVAL '10 hours' AS dt)
...
WITH appt AS (SELECT DATE_TRUNC('minute', NOW() + INTERVAL '5 days') + INTERVAL '14 hours' AS dt)
INSERT INTO appointments (patient_id, doctor_id, nurse_id, appointment_date, status, criticidade, notes, created_at)
VALUES (
...
WITH appt AS (SELECT DATE_TRUNC('minute', NOW() + INTERVAL '15 days') + INTERVAL '9 hours' AS dt)
INSERT INTO appointments (patient_id, doctor_id, nurse_id, appointment_date, status, criticidade, notes, created_at)
VALUES (
...
WITH appt AS (SELECT DATE_TRUNC('minute', NOW() + INTERVAL '15 days') + INTERVAL '11 hours' AS dt)
INSERT INTO appointments (patient_id, doctor_id, nurse_id, appointment_date, status, criticidade, notes, created_at)
VALUES (
...
WITH appt AS (SELECT DATE_TRUNC('minute', NOW() - INTERVAL '10 days') + INTERVAL '15 hours' AS dt)
INSERT INTO appointments (patient_id, doctor_id, nurse_id, appointment_date, status, criticidade, notes, created_at)
VALUES (
    (SELECT id FROM patients WHERE document = '12345678902'),
    (SELECT id FROM doctors WHERE crm = 'CRM66666'),
...
WITH appt AS (SELECT DATE_TRUNC('minute', NOW() + INTERVAL '20 days') + INTERVAL '16 hours' AS dt)
INSERT INTO appointments (patient_id, doctor_id, nurse_id, appointment_date, status, criticidade, notes, created_at)
VALUES (
    (SELECT id FROM patients WHERE document = 'DOC66666'),
    (SELECT id FROM doctors WHERE crm = 'CRM66666'),
